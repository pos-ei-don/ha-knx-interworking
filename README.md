...
2. Add `https://github.com/pos-ei-don/ha-knx-interworking`, category **Integration**
3. Install **KNX Interworking**, then restart Home Assistant
4. Settings → Devices & Services → **Add integration** → *KNX Interworking*

Open the integration's options to enable individual features. Diagnostics are safe to turn on first.
